...
class StatisticsRepository(RepositoryBase):
    ...
    # def getStatisticsByClientId(self, client_id):
    #     try:
    #         query = db.session.query(
    #             Statistics.ID_Estadistica,
    #             Statistics.FechaMedicion,
    #             Statistics.Estado,
    #             Client.Nombre,
    #             Client.Primer_Apellido
    #         ).join(Client, Statistics.ID_Cliente == Client.Cedula)\
    #          .filter(Statistics.ID_Cliente == client_id)

    #         result = query.all()
    #         return result if result else None

    #     except Exception as ex:
    #         raise Exception(f'Error en getStatisticsByClientId: {ex}')
