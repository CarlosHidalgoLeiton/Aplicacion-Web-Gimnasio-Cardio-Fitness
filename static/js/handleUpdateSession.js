...
$(document).ready(() => {
    ...
    const routineId = document.getElementById('routineId').getAttribute('data-routineId');
    ...
    document.getElementById('exerciseForm').addEventListener('submit', function (event) {
        ...
        updatedSessions = sessions.map((s) => {
            if (parseInt(s.Session_ID) === parseInt(id)) {
        ...
        window.location.href = `/trainer/UpdateRoutine/${clientId}/${routineId}`;
    });
